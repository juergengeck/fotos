...
export default defineConfig({
    ...
    resolve: {
        alias: [
            ...
            {find: '@refinio/local.core/BrowserMultimodalEmbeddingProvider.js', replacement: path.resolve(__dirname, '../../../one/packages/local.core/dist/BrowserEmbeddingProvider.js')},
